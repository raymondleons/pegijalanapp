// src/components/home/FerrySearchForm.js
...
const FerrySearchForm = () => {
    ...
    const handleSelectDate = (date) => {
        ...
        // Menutup modal setelah tanggal dipilih
        ...
        <View>
            ...
            <View style={styles.inputContainer}>
                <FormInput
                    ...
                    placeholder={t('ferry_from')}
                    value={from}
                    onChangeText={setFrom}
                />
                <FormInput
                    iconSource={require('../../assets/icons/location_pin.png')}
                    placeholder={t('ferry_to')}
                    value={to}
                    onChangeText={setTo}
                />
            ...
            {/* Tombol Cari */}
            <AppButton
                title={t('search_ferry')}
                onPress={() => console.log('Mencari Ferry...')}
